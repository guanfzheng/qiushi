<template>
	<view>
		<template v-if="!islogin">
			<!-- 未登录 -->
			<view class="u-f u-f-ajc">登陆仿糗百，体验更多功能</view>
			<!-- 第三方登陆 -->
			<other-login></other-login>
			<!-- 账号密码登陆 -->
			<view class="u-f u-f-ajc">账号密码登陆 <view class="icon iconfont icon-jinru"></view> </view>
		</template>
		<template v-else>
			<!-- 登陆 -->
		...
		<!-- 广告位 -->
		<view class="home-adv u-f u-f-ajc" >
			<image src="../../static/image/index-list.jpg" mode="widthFix" lazy-load></image>
		</view>
		<!-- 功能列表 -->
		...
		data() {
			return {
				...
				list:[
					...
					{ icon:"VIP",name:"糗百认证",clicktype:"",url:"" },
