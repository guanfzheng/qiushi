<template>
	<view class="animate__animated animate__fadeIn animate__fast" v-if="show">
		<view class="more-share-model" @tap="togle"></view>
		<view class="more-share">
			<view class="more-share-title u-f u-f-ajc">分享到</view>
			<scroll-view scroll-x class="more-share-body">
				<block v-for="(val,index) in providerList" :key="index">
					...
					@tap="share(val)">
						<view class="icon iconfont u-f u-f-ajc"
						:class="['icon-'+val.zicon,'more-share-'+val.zclass]"></view>
						<view>{{val.name}}</view>
					</view>
				</block>
			</scroll-view>
			<view class="more-share-bottom u-f u-f-ajc" hover-class="more-share-hover" @tap="togle">取消</view>
		</view>
